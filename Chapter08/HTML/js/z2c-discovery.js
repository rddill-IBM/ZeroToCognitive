...
function initiateAlchemy()
{
  ...
  // this is to support multiple languages. Check out the text folder in the controller (router)
  // for insight into how this works. 
  // updatePage() is in the z2c_utilities.js file
  updatePage('news')
  // do something useful when the get news button is clicked. 
  _btn.on("click",  function() {
    // get selector value

    console.log("initiateAlchemy button clicked");
    // check to make sure something useful has been entered in the company name field.
...
{
  // the following commented out lines of code are left in place to show conversion
  // from Alchemy to Watson Data News.
  //
