...
function initiateVR()
{
  ...
  {  console.log("browser supports drag and drop: "+b_Droppable);
      ...
      $form.on('submit', function(e) {
        ...
        e.preventDefault();
        if (droppedFiles == false) {c_res.append("<h3>Error: please select a file, first.")}
        else
          {if (droppedFiles[0].size > maxSize) {c_res.append("<h3>Error: File size too large. Image must be smaller than 2MB.")}
          else
          {
